...
// Configuration
const serviceName = "caltrain-commuter-app"; // replace with your service name
...
// Export logger for use in application code
...
export function initOtel() {
  try {
    ...
    logger.emit({
      ...
      severityText: "INFO",
      body: "OpenTelemetry SDK started for Caltrain Commuter App",
      attributes: { 
        service: serviceName,
