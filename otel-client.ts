...
// Configuration
const serviceName = "caltrain-commuter-app-client"; // Client-side service name
...
// Export logger, tracer, and meter for use in client-side code
...
export function initOtel() {
  try {
    ...
    logger.emit({
      ...
      severityText: "INFO",
      body: "OpenTelemetry Web SDK started for Caltrain Commuter App",
    });
  } catch (error) {
    logger.emit({
